                  ...
                  <div class="row specification">
                     ...
                     <h3>USES</h3>
                       <ul>
                            ...
                            <li>Easily block out all the light in the room</li>
                       </ul>
                     ...
                     <div class="col-6">
                        <img src="img/services/roller-blinds/roller-blinds-1.jpg" alt="">
                     </div>
                  </div>

                  <div class="row specification">
                     <div class="col-4">
                        <img src="img/services/roller-blinds/roller-blinds-2.jpg" alt="">
                     </div>
                     <div class="col-4">
                        <img src="img/services/roller-blinds/roller-blinds-3.jpg" alt="">
                     </div>
                     <div class="col-4">
                        <img src="img/services/roller-blinds/roller-blinds-4.jpg" alt="">
                     </div>
                  </div>
