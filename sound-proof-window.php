            ...
            <div class="row">
               ...
               <div class="col-9 services-inner" data-aos="fade-left" data-aos-duration="1000">
                  ...
                  <div class="row specification">
                     <div class="col-6">
                        <img src="img/services/sound-proof-window/sound-proof-window-1.jpg" alt="">
                     </div>
                     <div class="col-6">
                        <h5>USES</h5>
                        <ul>
                            <li>Reducing Traffic Noise</li>
                            <li>Blocking Urban Noise</li>
                  ...
                  <div class="row specification">
                     ...
                     <div class="col-6">
                        <img src="img/services/sound-proof-window/sound-proof-window-2.jpg" alt="">
                     </div>
                  </div>
